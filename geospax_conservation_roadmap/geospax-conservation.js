  ...
  GSX.renderWLCPanel = function (containerId) {
    ...
    host.innerHTML = layers.map(function (l, i) {
      ...
      '<div class="gsx-crit" data-idx="' + i + '" data-layer="' + l.id + '">' +
        ...
        '<div class="ad-row">' +
          '<label>Weight</label>' +
          '<input id="gsx-c-wt-' + i + '" type="number" value="1" min="0" step="0.1" style="width:5em">' +
          '<label>Method</label>' +
        ...
        '<div class="ad-row gsx-c-params" id="gsx-c-p-' + i + '">' +
          '<span id="gsx-c-pd-' + i + '" style="display:none">' +
            ...
            '<input id="gsx-c-dmax-' + i + '" type="number" value="1000" min="1" style="width:7em">' +
          '</span>' +
          '<span id="gsx-c-pn-' + i + '" style="display:none">' +
            '<label>Radius (m)</label>' +
            '<input id="gsx-c-rad-' + i + '" type="number" value="1000" min="1" style="width:6em">' +
            '<label>Saturation</label>' +
            '<input id="gsx-c-sat-' + i + '" type="number" value="5" min="1" style="width:5em">' +
          '</span>' +
